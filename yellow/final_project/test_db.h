...
#ifndef FINAL_PROJECT_TEST_DB_H
#define FINAL_PROJECT_TEST_DB_H
...
void TestsMyCustom()
{
...

  {
    ...
    AssertEqual(Event({2019, 12, 3}, "f"), db.Last({2019, 12, 4}), " My test 6");
    ...
    AssertEqual(Event({2019, 12, 2}, "c c"), db.Last({2019, 12, 2}), " My test 7");

    AssertEqual(Event({2019, 12, 3}, "f"), db.Last({2019, 12, 4}), " My test 8");

    db.Add({2019, 12, 3}, "m");
    AssertEqual(Event({2019, 12, 3}, "m"), db.Last({2019, 12, 3}), " My test 9");
...

  {
    ...
    AssertEqual(Event({2019, 12, 1}, "c"), db.Last({2019, 12, 1}), " My test 20");

    db.Add({2019, 12, 1}, "b");
    AssertEqual(Event({2019, 12, 1}, "c"), db.Last({2019, 12, 1}), " My test 21");
...
void TestDatabase() {
  ...
  // Last
  {
    ...
    db.Add(d1, "e1");
    db.Add(d2, "e2");
    AssertEqual(db.Last(d), Event({2018, 12, 22}, "e2"), "Db Last 1");
    Date d3(2018, 12, 24);
    db.Add(d3, "e3");
    AssertEqual(db.Last(d), Event({2018, 12, 24}, "e3"), "Db Last 2");
    ...
    AssertEqual(db.Last(d), Event({2018, 12, 22}, "e2"), "Db Last 4");

    AssertEqual(db.Last(d1), Event({2019, 1, 2}, "e1"), "Db Last 5");
    db.Add(d2, "e4");
    AssertEqual(db.Last(d2), Event({2018, 12, 22}, "e4"), "Db Last 6");
  }
