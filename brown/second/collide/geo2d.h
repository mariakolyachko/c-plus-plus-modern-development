...
#ifndef SECOND_GEO2D_H
#define SECOND_GEO2D_H
...
public:
  ...
  [[nodiscard]] int Left() const { return x_left; }
  [[nodiscard]] int Right() const { return x_right; }
  [[nodiscard]] int Top() const { return y_top; }
  [[nodiscard]] int Bottom() const { return y_bottom; }

  [[nodiscard]] Point BottomLeft() const { return {x_left, y_bottom}; }
  [[nodiscard]] Point BottomRight() const { return {x_right, y_bottom}; }
  [[nodiscard]] Point TopRight() const { return {x_right, y_top}; }
  [[nodiscard]] Point TopLeft() const { return {x_left, y_top}; }
};
