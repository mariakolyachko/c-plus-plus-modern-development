//
// Created by mariakolyachko on 14.03.20.
//

#ifndef SECOND_STATS_AGGREGATOR_H
#define SECOND_STATS_AGGREGATOR_H
...
private:
  // Ранее мы не рассматривали шаблон std::optional. О нём можно почитать в документации https://en.cppreference.com/w/cpp/utility/optional. Кроме того, ему будет уделено внимание в разделе про функции
...
#endif // SECOND_STATS_AGGREGATOR_H
